...
namespace FBAView {
	...
	/// Summary for Avatar
	/// </summary>
	public ref class Avatar : public System::Windows::Forms::Form
	{
	public:
		Avatar(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Avatar::typeid));
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &Avatar::pictureBox1_Click);
			// 
			// pictureBox2
			// 
			...
			this->pictureBox2->Click += gcnew System::EventHandler(this, &Avatar::pictureBox2_Click);
			// 
			// pictureBox3
			// 
			...
			this->pictureBox3->Click += gcnew System::EventHandler(this, &Avatar::pictureBox3_Click);
			// 
			// pictureBox4
			// 
			...
			this->pictureBox4->Click += gcnew System::EventHandler(this, &Avatar::pictureBox4_Click);
			// 
			// pictureBox5
			// 
			...
			this->pictureBox5->Click += gcnew System::EventHandler(this, &Avatar::pictureBox5_Click);
			// 
			// pictureBox6
			// 
			...
			this->pictureBox6->Click += gcnew System::EventHandler(this, &Avatar::pictureBox6_Click);
			// 
			// pictureBox7
			// 
			...
			this->pictureBox7->Click += gcnew System::EventHandler(this, &Avatar::pictureBox7_Click);
			// 
			// pictureBox8
			// 
			...
			this->pictureBox8->Click += gcnew System::EventHandler(this, &Avatar::pictureBox8_Click);
			// 
			// pictureBox9
			// 
			...
			this->pictureBox9->Click += gcnew System::EventHandler(this, &Avatar::pictureBox9_Click);
			// 
			// pictureBox10
			// 
			...
			this->pictureBox10->Click += gcnew System::EventHandler(this, &Avatar::pictureBox10_Click);
			// 
			// pictureBox11
			// 
			...
			this->pictureBox11->Click += gcnew System::EventHandler(this, &Avatar::pictureBox11_Click);
			// 
			// pictureBox12
			// 
			...
			this->pictureBox12->Click += gcnew System::EventHandler(this, &Avatar::pictureBox12_Click);
			// 
			// pictureBox13
			// 
			...
			this->pictureBox13->Click += gcnew System::EventHandler(this, &Avatar::pictureBox13_Click);
			// 
			// pictureBox14
			// 
			...
			this->pictureBox14->Click += gcnew System::EventHandler(this, &Avatar::pictureBox14_Click);
			// 
			// pictureBox15
			// 
			...
			this->pictureBox15->Click += gcnew System::EventHandler(this, &Avatar::pictureBox15_Click);
			// 
			// pictureBox16
			// 
			...
			this->pictureBox16->Click += gcnew System::EventHandler(this, &Avatar::pictureBox16_Click);
			// 
			// pictureBox17
			// 
			...
			this->pictureBox17->Click += gcnew System::EventHandler(this, &Avatar::pictureBox17_Click);
			// 
			// pictureBox18
			// 
			...
			this->pictureBox18->Click += gcnew System::EventHandler(this, &Avatar::pictureBox18_Click);
			// 
			// pictureBox19
			// 
			...
			this->pictureBox19->Click += gcnew System::EventHandler(this, &Avatar::pictureBox19_Click);
			// 
			// pictureBox20
			// 
			...
			this->pictureBox20->Click += gcnew System::EventHandler(this, &Avatar::pictureBox20_Click);
			// 
			// Avatar
			// 
